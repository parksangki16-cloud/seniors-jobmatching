    ...
    <div className="max-w-5xl mx-auto px-6 py-12 space-y-16">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            {
              label: "미매칭 시니어", key: "unmatched" as const,
              bg: "bg-red-50 border-red-300", num: "text-red-700", lbl: "text-red-600",
              icon: (
                <svg className="w-10 h-10 mx-auto mb-3 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                </svg>
              ),
            },
            {
              label: "매칭 대기", key: "pending" as const,
              bg: "bg-yellow-50 border-yellow-300", num: "text-yellow-700", lbl: "text-yellow-600",
              icon: (
                <svg className="w-10 h-10 mx-auto mb-3 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              ),
            },
            {
              label: "배정 완료", key: "assigned" as const,
              bg: "bg-green-50 border-green-300", num: "text-green-700", lbl: "text-green-600",
              icon: (
